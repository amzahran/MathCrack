                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="easy_points" name="easy_points" min="0" max="100" value="{{ old('easy_points', $assignment->easy_points ?? 1) }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="medium_points" name="medium_points" min="0" max="100" value="{{ old('medium_points', $assignment->medium_points ?? 2) }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="hard_points" name="hard_points" min="0" max="100" value="{{ old('hard_points', $assignment->hard_points ?? 3) }}">
