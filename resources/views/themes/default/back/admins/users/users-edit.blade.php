                                ...
                                <form id="formAccountSettings" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <select id="country" class="form-control" name="country" data-select2-selector="language">
                                            ...
                                            <form id="formAccountSettingsApiKey" method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="mb-3 col-12">
                                                        ...
                                                        <select name="role" class="select2 form-select" required data-select2-selector="language">
