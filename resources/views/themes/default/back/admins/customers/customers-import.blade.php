...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">@lang('l.Import Customers')</h5>
                    <div class="card-body">
                        @if (session('success'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('dashboard.admins.customers-import-post') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="drop-zone">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a href="{{ asset('templates/customers-import-template.csv') }}" target="_blank" class="btn btn-outline-primary">
                                                <i class="bx bx-download me-1"></i>@lang('l.Download CSV Template')
                                            </a>
                                            <a href="{{ asset('templates/customers-import-template.xlsx') }}" target="_blank" class="btn btn-outline-primary">
