...
<div class="main-content">
                ...
                <div class="col-md-4 text-end">
                    <div class="stats-summary">
                        ...
                        <span class="stats-badge">
                            ...
                            <?php echo e($totalTests); ?> Tests Available
                        </span>
                    </div>
                </div>
            </div>
    ...
    <!-- في قسم الفلاتر -->
<form id="filtersForm" method="GET" action="<?php echo e(route('dashboard.users.tests.index')); ?>" class="row g-3 mb-3">
    <div class="col-md-4">
        <label class="form-label">Level</label>
        <select id="levelSelect" name="level_id" class="form-select">
            <option value="">All Levels</option>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lvl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($lvl->id); ?>" <?php echo e(request('level_id') == $lvl->id ? 'selected' : ''); ?>>
                    <?php echo e($lvl->name); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($coursesWithTests->count() > 0): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $coursesWithTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="course-section">
                <!-- Course Header -->
                <div class="course-header">
                    <h2 class="course-title"><?php echo e($course['name']); ?></h2>
                    <div class="course-meta">
                        <div class="course-meta-item">
                            <i class="fas fa-clipboard-list"></i>
                            <span><?php echo e($course['tests']->count()); ?> <?php echo app('translator')->get('l.tests'); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course['tests_price'] > 0): ?>
                            <div class="course-meta-item">
                                <i class="fas fa-tag"></i>
                                <span><?php echo app('translator')->get('l.course_tests_price'); ?>: <?php echo e(number_format($course['tests_price'], 2)); ?> <?php echo app('translator')->get('l.currency'); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course['has_purchased_all']): ?>
                            <div class="course-meta-item">
                                <i class="fas fa-check-circle"></i>
                                <span><?php echo app('translator')->get('l.all_tests_purchased'); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="tests-grid">
                    <div class="row">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $course['tests']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
                                <div class="test-card">
                                    <!-- Card Header -->
                                    <div class="card-header">
                                        <h3 class="test-title"><?php echo e($test['name']); ?></h3>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($test['description']): ?>
                                            <p class="test-description"><?php echo e(Str::limit($test['description'], 80)); ?></p>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="test-stats">
                                            <div class="stat-item">
                                                <span class="stat-number"><?php echo e($questionsTotal); ?></span>
                                                <div class="stat-label"><?php echo app('translator')->get('l.questions'); ?></div>
                                            </div>

                                            <div class="stat-item">
                                                <span class="stat-number"><?php echo e($timeTotal); ?></span>
                                                <div class="stat-label"><?php echo app('translator')->get('l.minutes'); ?></div>
                                            </div>

                                            <div class="stat-item">
                                                <span class="stat-number"><?php echo e($modulesCount); ?></span>
                                                <div class="stat-label"><?php echo app('translator')->get('l.modules'); ?></div>
                                            </div>

                                            <div class="stat-item">
                                                <span class="stat-number"><?php echo e($test['total_score']); ?></span>
                                                <div class="stat-label"><?php echo app('translator')->get('l.points'); ?></div>
                                            </div>
                                        </div>

                                        <!-- Price Section -->
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($test['price'] > 0 && !$test['has_paid']): ?>
                                            <div class="price-section">
                                                <div class="price-amount"><?php echo e(number_format($test['price'], 2)); ?> <?php echo app('translator')->get('l.currency'); ?></div>
                                                <div class="price-label"><?php echo app('translator')->get('l.test_price'); ?></div>
                                            </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                        <!-- Test Status -->
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($test['has_paid']): ?>
                                            <div class="test-status">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($test['status']):
                                                    case ('not_started'): ?>
                                                        <span class="status-badge status-not-started">
                                                            <i class="fas fa-play-circle"></i>
                                                            <?php echo app('translator')->get('l.not_started'); ?>
                                                        </span>
                                                        <?php break; ?>
                                                    ...
                                                    <?php case ('part2_in_progress'): ?>
                                                        <span class="status-badge status-in-progress">
                                                            ...
                                                            <?php echo app('translator')->get('l.in_progress'); ?>
                                                        </span>
                                                        <?php break; ?>
                                                    <?php case ('completed'): ?>
                                                    ...
                                                    <?php default: ?>
                                                        <span class="status-badge status-locked">
                                                            ...
                                                            <?php echo app('translator')->get('l.locked'); ?>
                                                        </span>
                                        ...
                                        <div class="test-actions">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($test['has_paid']): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($test['status']):
                                                    case ('not_started'): ?>
                                                        <a href="<?php echo e(route('dashboard.users.tests.show', $test['id'])); ?>" class="btn-test btn-primary-test">
                                                    ...
                                                    <?php case ('in_break'): ?>
                                                    <?php case ('part2_in_progress'): ?>
                                                        <a href="<?php echo e(route('dashboard.users.tests.take', $test['id'])); ?>" class="btn-test btn-warning-test">
                                                            <i class="fas fa-forward"></i>
                                                            <?php echo app('translator')->get('l.continue_test'); ?>
                                                        </a>
                                                        <?php break; ?>
                                                    <?php case ('completed'): ?>
                                                        <a href="<?php echo e(route('dashboard.users.tests.results', $test['id'])); ?>" class="btn-test btn-success-test">
                                                ...
                                                <?php endswitch; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php else: ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($test['price'] > 0): ?>
                                                    <a href="<?php echo e(route('dashboard.users.tests.purchase.test', $test['id'])); ?>" class="btn-test btn-primary-test">
                                                        <i class="fas fa-shopping-cart"></i>
                                                        <?php echo app('translator')->get('l.purchase_test'); ?>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('dashboard.users.tests.show', $test['id'])); ?>" class="btn-test btn-success-test">
                                                        <i class="fas fa-gift"></i>
                                                        <?php echo app('translator')->get('l.access_free_test'); ?>
                                                    </a>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($course['tests_price'] > 0 && !$course['has_purchased_all']): ?>
                        <div class="course-purchase-section">
                            <div class="course-purchase-info">
                                <div class="course-purchase-price">
                                    <?php echo e(number_format($course['tests_price'], 2)); ?> <?php echo app('translator')->get('l.currency'); ?>
                                </div>
                                <div class="course-purchase-desc">
                                    <?php echo app('translator')->get('l.purchase_all_course_tests_desc'); ?>
                                </div>
                            </div>
                            <a href="<?php echo e(route('dashboard.users.tests.purchase.course-tests', $course['id'])); ?>" class="btn-test btn-primary-test" style="max-width: 300px; margin: 0 auto;">
                                <i class="fas fa-shopping-cart"></i>
                                <?php echo app('translator')->get('l.purchase_all_tests'); ?>
                            </a>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
    ...
    <?php else: ?>
        <div class="no-tests">
            <i class="fas fa-clipboard-list"></i>
            <h3><?php echo app('translator')->get('l.no_tests_available'); ?></h3>
            <p><?php echo app('translator')->get('l.no_tests_description'); ?></p>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('themes.default.layouts.back.student-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u121952710/domains/mathcrack.com/public_html/resources/views/themes/default/back/users/tests/index.blade.php ENDPATH**/ ?>