...
<?php $__env->startSection('content'); ?>
    <div class="main-content">
        ...
        <div class="debug-info">
            ...
            <p><strong>Number of Attempts:</strong> <?php echo e($attempts->count()); ?></p>
            <p><strong>Number of Questions:</strong> <?php echo e($questions->count()); ?></p>
            <?php
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $attempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <p><strong>Attempt <?php echo e($index + 1); ?>:</strong> 
                   <?php echo e($attempt->answers->count()); ?> answers - 
                   Score: <?php echo e($attempt->final_score); ?>/<?php echo e($test->total_score); ?>
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <p><?php echo e($test->name); ?> - Comparison between attempts</p>
                    </div>
        ...
        <div class="overall-stats">
            ...
            <div class="overall-stats-grid">
                ...
                ?>
                <div>
                    <div class="overall-stat-value"><?php echo e($averageScore); ?>/<?php echo e($test->total_score); ?></div>
                    <div class="overall-stat-label">Average Score</div>
                </div>
                <div>
                    <div class="overall-stat-value"><?php echo e($averagePercentage); ?>%</div>
                    <div class="overall-stat-label">Average Percentage</div>
                </div>
                <div>
                    <div class="overall-stat-value"><?php echo e($attempts->count()); ?></div>
                    <div class="overall-stat-label">Total Attempts</div>
                </div>
                <div>
                    <div class="overall-stat-value"><?php echo e($questions->count()); ?></div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $attempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="stat-box">
                    <div class="attempt-header">
                        <div class="attempt-number">Attempt <?php echo e($index + 1); ?></div>
                        <div class="attempt-date"><?php echo e($attempt->created_at->format('Y-m-d H:i')); ?></div>
                    </div>
                    <div class="stat-value"><?php echo e(number_format($attempt->final_score, $attempt->final_score == intval($attempt->final_score) ? 0 : 1)); ?>/<?php echo e($test->total_score); ?></div>
                    <div class="stat-label">Score</div>
                    <div class="stat-value"><?php echo e(number_format(($attempt->final_score / $test->total_score) * 100, 1)); ?>%</div>
                    <div class="stat-label">Percentage</div>
                    
                    <div class="attempt-stats">
                        <div class="attempt-stat">
                            <div class="attempt-stat-value correct-stat"><?php echo e($correctCount); ?></div>
                            <div class="attempt-stat-label">Correct</div>
                        </div>
                        <div class="attempt-stat">
                            <div class="attempt-stat-value incorrect-stat"><?php echo e($incorrectCount); ?></div>
                        ...
                        <tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $attempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <th style="min-width: 150px;">
                                    <div>Attempt <?php echo e($index + 1); ?></div>
                                    <div class="attempt-date"><?php echo e($attempt->created_at->format('M d, Y')); ?></div>
                                </th>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="module-divider">
                                    <td colspan="<?php echo e($attempts->count() + 2); ?>">
                                        All Questions - Questions 1 to <?php echo e($questions->count()); ?>

                                    </td>
                                </tr>
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $answers = [];
                                        foreach ($attempts as $attempt) {
                                    ...
                                    <tr>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td>
                                                <span class="badge bg-<?php echo e($status[1]); ?>"><?php echo e($status[0]); ?></span>
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        
                                        <td>
                                            <span class="badge bg-<?php echo e($progress['tone']); ?>"><?php echo e($progress['label']); ?></span>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php
        ...
        <div class="action-buttons">
            <a href="<?php echo e(route('dashboard.users.tests.results', $test->id)); ?>" class="btn-action btn-primary">
                <i class="fas fa-arrow-left"></i>
                Back to Results
            </a>
            
            <a href="<?php echo e(route('dashboard.users.tests.show', $test->id)); ?>" class="btn-action btn-secondary">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes.default.layouts.back.student-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u121952710/domains/mathcrack.com/public_html/resources/views/themes/default/back/users/tests/comparison.blade.php ENDPATH**/ ?>