...
<head>
  ...
  <title><?php echo e($headerTitle); ?></title>
...
<div class="app">
  <div class="topbar">
    <div class="topbar-inner">
      <div class="brand"><?php echo e($headerTitle); ?></div>
    ...
    <div class="container">
      ...
      <div class="module-indicator">
        ...
        <div class="module-indicator-text">
          ...
          <span class="module-indicator-value">
            Module
            <span class="module-indicator-number"><?php echo e($moduleNumber); ?></span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($maxModule > 1): ?>
              <span class="module-indicator-total">of <?php echo e($maxModule); ?></span>
      ...
      <div class="workspace no-calc" id="workspace">
        ...
        <div class="q-card" id="qCard">
          ...
          <form id="answerForm">
            <input type="hidden" id="student_test_id" value="<?php echo e($studentTest->id ?? (auth()->id().'-'.$test->id)); ?>">
            <input type="hidden" name="question_id" id="question_id" value="">
            <input type="hidden" id="markedField" value="0">

            <div class="q-body">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="question-item" data-question-index="<?php echo e($i); ?>" data-question-id="<?php echo e($q->id); ?>" style="display: <?php echo e($i === 0 ? 'block':'none'); ?>;">
                  
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($q->question_image)): ?>
                    <div class="question-image">
                      <img src="<?php echo e(asset($q->question_image)); ?>" 
                           alt="Question Image"
                  ...
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($q->type === 'mcq'): ?>
                    <div class="options options-container">
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($q->options) && count($q->options) > 0): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $q->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <div class="option-row">
                            <div class="option-item" data-option-id="<?php echo e($opt->id); ?>" onclick="selectMCQOption(this, <?php echo e($q->id); ?>)">
                              <div class="option-label">
                                <span><?php echo e($opt->label ?? chr(64 + $loop->iteration)); ?></span>
                              </div>
                              <div class="option-text">
                                <?php echo nl2br($opt->option_text); ?>

                                
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($optionImage): ?>
                                  <div class="option-image">
                                    <img src="<?php echo e(asset($optionImage)); ?>" 
                                         alt="Option Image"
                                         onerror="this.style.display='none';">
                                  </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="external-elimination-letter" data-letter="<?php echo e($opt->label ?? chr(64 + $loop->iteration)); ?>">
                              <?php echo e($opt->label ?? chr(64 + $loop->iteration)); ?>
                      ...
                      <?php else: ?>
                        ...
                        <div class="option-row">
                          <div class="option-item" data-option-id="1" onclick="selectMCQOption(this, <?php echo e($q->id); ?>)">
                            <div class="option-label">
                              <span>A</span>
                            </div>
                        ...
                        <div class="option-row">
                          <div class="option-item" data-option-id="2" onclick="selectMCQOption(this, <?php echo e($q->id); ?>)">
                            <div class="option-label">
                              <span>B</span>
                            </div>
                            <div class="option-text">\( P = 63n + 120,000 \)</div>
                        ...
                        <div class="option-row">
                          <div class="option-item" data-option-id="3" onclick="selectMCQOption(this, <?php echo e($q->id); ?>)">
                            <div class="option-label">
                              <span>C</span>
                            </div>
                        ...
                        <div class="option-row">
                          <div class="option-item" data-option-id="4" onclick="selectMCQOption(this, <?php echo e($q->id); ?>)">
                            <div class="option-label">
                              <span>D</span>
                            </div>
                            <div class="option-text">\( P = 63(n + 120,000) \)</div>
                  ...
                  <?php elseif($q->type === 'tf'): ?>
                    <div class="options tf-options">
                      <div class="option-row">
                        <div class="option-item tf-option" data-value="True" onclick="selectTFOption(this, <?php echo e($q->id); ?>)">
                          <div class="option-label">
                            <span>T</span>
                          </div>
                      ...
                      <div class="option-row">
                        <div class="option-item tf-option" data-value="False" onclick="selectTFOption(this, <?php echo e($q->id); ?>)">
                          <div class="option-label">
                            <span>F</span>
                          </div>
                      ...
                      <div class="numeric-answer-box">
                        <input
                          ...
                          oninput="
                            ...
                            saveNumericAnswer(this, <?php echo e($q->id); ?>);
                          "
                        >
                      </div>
                    </div>
    ...
    <div class="questions-bar-inner">
      ...
      <div class="questions-scroll-container">
        <div class="questions-numbers" id="questionsBarNumbers">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button type="button" class="question-bar-btn <?php echo e($i===0 ? 'current' : ''); ?>"
                    data-question-index="<?php echo e($i); ?>"
                    onclick="goToQuestion(<?php echo e($i); ?>)">
              <?php echo e($i+1); ?>
  ...
  <div class="footer">
    <div class="footer-inner">
      <div><?php echo e(auth()->user()->name ?? 'Student'); ?></div>
      <div class="pill">Question <span id="current-question-number">1</span> of <?php echo e($totalQuestions); ?></div>
  ...
  <div id="refBackdrop" style="display:none;position:fixed;inset:0;background:rgba(15,23,42,.85);z-index:2000;align-items:center;justify-content:center">
    <div class="ref-modal">
      ...
      <div class="ref-modal-body">
        <iframe
          src="<?php echo e(asset('Pdfs/References.pdf')); ?>#toolbar=0&navpanes=0&scrollbar=0"
          class="pdf-iframe"
...
<script>
  const TestConfig = {
    TEST_ID: <?php echo json_encode($test->id ?? ($test_id ?? request()->route('id')), 15, 512) ?>,
    currentPart: <?php echo json_encode($currentPart ?? 'part1', 15, 512) ?>,
    totalQuestions: <?php echo e((int)($questions->count() ?? 0)); ?>,
    studentTestId: '<?php echo e($studentTest->id ?? (auth()->id()."-".$test->id)); ?>',

    URLs: {
      TIMER_BASE: <?php echo json_encode($TIMER_URL_BASE, 15, 512) ?>,
      SUBMIT_PART1: <?php echo json_encode($SUBMIT_PART1_URL, 15, 512) ?>,
      SUBMIT_PART2: <?php echo json_encode($SUBMIT_PART2_URL, 15, 512) ?>,
      SUBMIT_TEST: <?php echo json_encode($SUBMIT_TEST_URL, 15, 512) ?>,
      SAVE_ANSWER: <?php echo json_encode($SAVE_ANSWER_URL, 15, 512) ?>,
      UPDATE_TIMER: <?php echo json_encode($UPDATE_TIMER_URL, 15, 512) ?>
    },

    Timer: {
      remaining: Math.floor(<?php echo e($timerSeconds); ?>),
      isPaused: false,
      interval: null,
      lastUpdate: Date.now()
    }
...
</html><?php /**PATH /home/u121952710/domains/mathcrack.com/public_html/resources/views/themes/default/back/users/tests/take.blade.php ENDPATH**/ ?>