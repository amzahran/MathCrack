...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" dir="<?php echo e(app()->getLocale()==='ar' ? 'rtl' : 'ltr'); ?>">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/themes/default/vendors/css/daterangepicker.min.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/themes/default/vendors/css/select2.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/themes/default/vendors/css/select2-theme.min.css')); ?>">
    <!--! END: Vendors CSS-->
  ...
  <body>
    ...
    <div class="nxl-container">
      ...
      <div class="nxl-content">
        ...
        <div class="page-header">
          <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
              <h5 class="m-b-10"><?php echo app('translator')->get('l.Dashboard'); ?></h5>
            </div>
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo app('translator')->get('l.Home'); ?></a></li>
              <li class="breadcrumb-item"><?php echo $__env->yieldContent('title'); ?></li>
            </ul>
          </div>
        ...
        <div class="page-body">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('impersonated_by')): ?>
            <a href="<?php echo e(route('impersonate.leave')); ?>"
              ...
              title="<?php echo app('translator')->get('l.Leave'); ?>">
    ...
    <script src="<?php echo e(asset('assets/themes/default/js/dashboard-init.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/themes/default/vendors/js/select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/themes/default/vendors/js/select2-active.min.js')); ?>"></script>
    <!--! END: Apps Init !-->
...
</html><?php /**PATH /home/u121952710/domains/mathcrack.com/public_html/resources/views/themes/default/layouts/back/master.blade.php ENDPATH**/ ?>