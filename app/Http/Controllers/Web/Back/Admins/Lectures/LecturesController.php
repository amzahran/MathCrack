...
class LecturesController extends Controller
{
    ...
    public function storeAssignment(Request $request)
    {
        ...
        $request->validate([
            ...
            'easy_points' => 'nullable|integer|min:0|max:100',
            'medium_points' => 'nullable|integer|min:0|max:100',
            'hard_points' => 'nullable|integer|min:0|max:100',
        ...
        LectureAssignment::create([
            ...
            'easy_points' => $request->filled('easy_points') ? (int) $request->easy_points : 1,
            'medium_points' => $request->filled('medium_points') ? (int) $request->medium_points : 2,
            'hard_points' => $request->filled('hard_points') ? (int) $request->hard_points : 3,
    ...
    public function storeQuestion(Request $request)
    {
        ...
        try {
            ...
            $question = LectureQuestion::create([
                ...
                'difficulty' => $request->input('difficulty', 'medium') ?: 'medium',
