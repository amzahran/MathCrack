<?php
// في App\Http\Requests\UpdateTestRequest.php
...
class UpdateTestRequest extends FormRequest
{
    ...
    {
        $testId = $this->route('test'); // test هو اسم الـ route parameter
        ...
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('tests')->where(function ($query) use ($courseId, $testId) {
    ...
    {
        // نفس التحضير الموجود في StoreTestRequest
